...
import api_automation.RequestBuilder.APIRequestBuilder;
...
public class APIPOST {
	...
	public void user_create_request_data_with(String name, String email, String gender, String location) throws JsonProcessingException {
		 //Create request in Java object 
		APIRequestBuilder reqBuilder=new APIRequestBuilder();
	...
	public void user_sumbits_POST_request_to_api() {
		      response=given()
